	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'photo',title:'头像',width:100,height:61,align:'center',
 		        ...
 		        {field:'clazzName',title:'所属班级',width:150, sortable: true},
		...
		<form id="photoForm" method="post" enctype="multipart/form-data" action="upload_photo" target="photo_target">
	    	<table id="addTable1" cellpadding="8">
	    		<tr >
	    			<td>预览头像:</td>
	    			<td>
	    				<img id="photo-preview" alt="照片" style="max-width: 100px; max-height: 100px;" title="照片" src="/student/upload/student.jpg" />
	    			</td>
	    		</tr>
	    		<tr >
	    			<td>学生头像:</td>
   		...
   		<form id="addForm" method="post">
	    	<table id="addTable2" cellpadding="8">
	    		...
	    		<tr >
	    			<td>学生性别:</td>
	    			<td>
	    				<select id="add_sex"  class="easyui-combobox" panelHeight="50" style="width: 200px;" name="sex" data-options="required:true, missingMessage:'请选择学生性别'">
