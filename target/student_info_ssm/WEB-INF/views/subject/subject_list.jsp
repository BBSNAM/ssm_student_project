	...
	$(function() {
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'name',title:'学科名',width:150, sortable: true},
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "如果学科下存在专业信息或其他信息则无法删除，须先删除学科下属的所有信息！<span style='color:red;'>并且该操作不可逆，请慎重！</span>", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "delete",
...
<body>
	...
	<div id="toolbar">
		...
		<div>
			...
			学科名：<input id="search-name" class="easyui-textbox" />
   		...
   		<form id="addForm" method="post">
	    	<table id="addTable" cellpadding="8">
	    		<tr >
	    			<td>学科名:</td>
	    			<td>
	    				<input id="add_name"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="name" data-options="required:true, missingMessage:'请填写学科名'"  />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>备注:</td>
    	...
    	<form id="editForm" method="post">
	    	...
	    	<table id="editTable" border=0 cellpadding="8" >
	    		<tr >
	    			<td>学科名:</td>
	    			<td>
	    				<input id="edit_name"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="name" data-options="required:true, missingMessage:'请填写学科名'"  />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>备注:</td>
