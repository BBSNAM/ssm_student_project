	...
	$(function() {
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'gName',title:'所属年级',width:150, sortable: true},
 		        {field:'clazzNo',title:'班级编号',width:150, sortable: true},
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "如果班级下存在学生信息则无法删除，须先删除班级下属的所有学生信息！<span style='color:red;'>并且该操作不可逆，请慎重！</span>", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "delete",
